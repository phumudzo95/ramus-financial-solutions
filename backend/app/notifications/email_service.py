...
EMAIL_TEMPLATES: dict[str, dict] = {
    "application_submitted": {
        "subject": "Application Received — Ramus Financial Solutions",
        "body_html": """
...
<div style="background:#0a2463;padding:20px;text-align:center">
  <h1 style="color:#FFD700;margin:0">Ramus Financial Solutions</h1>
</div>
...
<div style="background:#0a2463;padding:15px;text-align:center;color:#aaa;font-size:12px">
  <p style="color:#aaa">Ramus Financial Solutions — Registered Credit Provider | NCR Registration: NCRCP19178</p>
</div>
</body></html>""",
    },
    "status_changed": {
        "subject": "Application Update — Ramus Financial Solutions (Ref: $reference_number)",
        "body_html": """
<html><body style="font-family:Arial,sans-serif;color:#1a1a2e;max-width:600px;margin:0 auto">
<div style="background:#0a2463;padding:20px;text-align:center">
  <h1 style="color:#FFD700;margin:0">Ramus Financial Solutions</h1>
...
<div style="background:#0a2463;padding:15px;text-align:center;font-size:12px">
  <p style="color:#aaa">Ramus Financial Solutions — Registered Credit Provider</p>
</div>
</body></html>""",
    },
    "approved": {
        "subject": "Congratulations! Your Application is Approved — Ramus Financial Solutions",
        "body_html": """
<html><body style="font-family:Arial,sans-serif;color:#1a1a2e;max-width:600px;margin:0 auto">
<div style="background:#0a2463;padding:20px;text-align:center">
  <h1 style="color:#FFD700;margin:0">Ramus Financial Solutions</h1>
...
<div style="padding:30px">
  ...
  <div style="background:#eafaf1;border-left:4px solid #27ae60;padding:15px;margin:20px 0">
    ...
    <strong>Repayment Term:</strong> $approved_term_label<br>
    <strong>Cost of Credit:</strong> $approved_rate_percent% (fixed)<br>
    <strong>Total Repayable:</strong> R$total_repayable<br>
...
<div style="background:#0a2463;padding:15px;text-align:center;font-size:12px">
  <p style="color:#aaa">Ramus Financial Solutions — Registered Credit Provider</p>
    ...
    "declined": {
        "subject": "Application Decision — Ramus Financial Solutions (Ref: $reference_number)",
        "body_html": """
<html><body style="font-family:Arial,sans-serif;color:#1a1a2e;max-width:600px;margin:0 auto">
<div style="background:#0a2463;padding:20px;text-align:center">
  <h1 style="color:#FFD700;margin:0">Ramus Financial Solutions</h1>
...
<div style="background:#0a2463;padding:15px;text-align:center;font-size:12px">
  <p style="color:#aaa">Ramus Financial Solutions — NCR Registration: NCRCP19178</p>
</div>
</body></html>""",
    },
    "document_requested": {
        "subject": "Additional Documents Required — Ramus Financial Solutions (Ref: $reference_number)",
        "body_html": """
<html><body style="font-family:Arial,sans-serif;color:#1a1a2e;max-width:600px;margin:0 auto">
<div style="background:#0a2463;padding:20px;text-align:center">
  <h1 style="color:#FFD700;margin:0">Ramus Financial Solutions</h1>
...
<div style="background:#0a2463;padding:15px;text-align:center;font-size:12px">
  <p style="color:#aaa">Ramus Financial Solutions — Registered Credit Provider</p>
    ...
    "manual_review_assigned": {
        "subject": "Application Under Review — Ramus Financial Solutions (Ref: $reference_number)",
        "body_html": """
<html><body style="font-family:Arial,sans-serif;color:#1a1a2e;max-width:600px;margin:0 auto">
<div style="background:#0a2463;padding:20px;text-align:center">
  <h1 style="color:#FFD700;margin:0">Ramus Financial Solutions</h1>
...
class EmailNotificationService:
    ...
    async def notify_approved(
        ...
        # approved_term_months: 0 = single payment in full after 30 days, 1-6 = instalments
        if approved_term_months == 0:
            approved_term_label = "Pay in full after 30 days"
        else:
            approved_term_label = f"{approved_term_months} monthly instalment{'s' if approved_term_months != 1 else ''}"

        from decimal import Decimal
        total_repayable = (
            Decimal(approved_amount) * (Decimal("1") + Decimal(approved_rate_percent) / Decimal("100"))
        ...
        await self.send(
            ...
            template_vars={
                ...
                "approved_term_label": approved_term_label,
