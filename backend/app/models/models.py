...
class Application(Base, TimestampMixin):
    ...
    __table_args__ = (
        CheckConstraint("requested_amount > 0 AND requested_amount <= 5000", name="ck_app_amount_range"),
        CheckConstraint("requested_term_months >= 0 AND requested_term_months <= 6", name="ck_app_term_range"),
