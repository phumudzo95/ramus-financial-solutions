...
class WorkflowEngine:
    ...
    async def auto_assign(self, application: Application) -> Optional[User]:
        ...
        event = WorkflowEvent(
            ...
            event_metadata={"worker_id": str(worker_id)},
        )
        self.db.add(event)
        ...
        await self.audit.log(
            ...
            log_metadata={"assignment_type": "auto"},
        )
    ...
    async def manual_assign(
        ...
        event = WorkflowEvent(
            ...
            event_metadata={"previous_worker": str(old_worker) if old_worker else None},
        )
        self.db.add(event)
        ...
        await self.audit.log(
            ...
            log_metadata={"assignment_type": "manual"},
        )
    ...
    async def escalate(
        ...
        event = WorkflowEvent(
            ...
            reason=reason,
            event_metadata={"escalated_by": str(escalated_by.id) if escalated_by else "system"},
        )
        self.db.add(event)
