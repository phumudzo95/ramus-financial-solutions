...
CONSENT_TEXTS = {
    ConsentPurpose.CREDIT_CHECK: (
        "I authorise Ramus Cash Loans (Pty) Ltd, a registered credit provider "
        "(NCR Registration: NCRCP XXXX), to request my credit report and credit "
    ...
    ConsentPurpose.AFFORDABILITY_ASSESSMENT: (
        "I authorise Ramus Cash Loans (Pty) Ltd to use my provided financial "
