...
// Lightweight responsive rules for containers below that use fixed inline widths.
// Targets: .rfs-w-layout (queue panel + detail panel row), .rfs-w-queue (fixed 310px queue),
// .rfs-w-header (top header row).
const RESPONSIVE_CSS = `
  @media (max-width: 900px) {
    .rfs-w-layout { flex-direction: column !important; height: auto !important; }
    .rfs-w-queue { width: 100% !important; max-height: 220px; border-right: none !important; border-bottom: 1px solid #E5E7EB; }
  }
  @media (max-width: 640px) {
    .rfs-w-header { padding: 10px 14px !important; flex-wrap: wrap; gap: 8px !important; }
    .rfs-w-header > div:nth-child(2) > div:first-child { font-size: 13px !important; }
    .rfs-w-app-hdr { flex-direction: column !important; align-items: stretch !important; gap: 14px !important; }
    .rfs-w-action-btns { flex-wrap: wrap; }
    .rfs-w-action-btns button { flex: 1; }
    .rfs-w-score-row { flex-direction: column !important; align-items: stretch !important; }
    .rfs-w-score-grid { width: 100% !important; }
  }
`;
...
const QUEUE = [
  { id: "a1", ref: "RCL-X7K29MQA", applicant: "T. Mokoena", amount: 4500, status: "manual_review", age_hours: 3.5, score: 612, dti: "38%", negatives: 1, priority: 2 },
  { id: "a2", ref: "RCL-B4R72NWP", applicant: "N. van der Berg", amount: 2000, status: "under_review", age_hours: 1.2, score: 741, dti: "22%", negatives: 0, priority: 1 },
  { id: "a3", ref: "RCL-K5T11QXZ", applicant: "M. Khumalo", amount: 5000, status: "under_review", age_hours: 5.1, score: 558, dti: "41%", negatives: 2, priority: 1 },
];
...
export default function WorkerDashboard() {
  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", minHeight: "100vh", background: "#F9FAFB" }}>
      <ResponsiveStyle />
      {/* Header */}
      <div className="rfs-w-header" style={{ background: NAVY, color: "#fff", display: "flex", alignItems: "center", gap: 14, padding: "12px 24px", borderBottom: `3px solid ${GOLD}` }}>
        ...
        <div>
          <div style={{ fontWeight: 700, fontSize: 15, letterSpacing: 0.3 }}>RAMUS FINANCIAL SOLUTIONS</div>
      ...
      <div className="rfs-w-layout" style={{ display: "flex", height: "calc(100vh - 62px)" }}>
        {/* Queue panel */}
        <div className="rfs-w-queue" style={{ width: 310, background: "#fff", borderRight: "1px solid #E5E7EB", overflowY: "auto", flexShrink: 0 }}>
        ...
        {selected && (
          <div style={{ flex: 1, overflowY: "auto", padding: "24px 28px" }}>
            ...
            <div style={{ background: "#fff", border: "1px solid #E5E7EB", borderRadius: 12, padding: "20px 24px", marginBottom: 20 }}>
              <div className="rfs-w-app-hdr" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                <div>
                ...
                <div className="rfs-w-action-btns" style={{ display: "flex", gap: 10 }}>
            ...
            {subTab === "credit" && (
              <div>
                ...
                <div style={{ background: "#fff", border: "1px solid #E5E7EB", borderRadius: 12, padding: "24px", marginBottom: 16 }}>
                  ...
                  <div className="rfs-w-score-row" style={{ display: "flex", alignItems: "center", gap: 32 }}>
                    <div style={{ textAlign: "center" }}>
                      ...
                      <div style={{ marginTop: 10, background: "#F3F4F6", borderRadius: 4, height: 8, width: 120, marginLeft: "auto", marginRight: "auto" }}>
                        <div style={{ width: `${scorePct}%`, background: scoreColor, borderRadius: 4, height: 8 }} />
                      </div>
                    </div>
                    <div className="rfs-w-score-grid" style={{ flex: 1, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
                      {[
