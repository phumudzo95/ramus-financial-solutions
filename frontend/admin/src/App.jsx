...
const mockApplications = [
  { id: "a1", ref: "RCL-X7K29MQA", applicant: "T. Mokoena", amount: 15000, status: "manual_review", worker: "S. Dlamini", submitted: "2026-06-10", score: 612 },
  { id: "a2", ref: "RCL-B4R72NWP", applicant: "N. van der Berg", amount: 8500, status: "under_review", worker: "K. Naidoo", submitted: "2026-06-10", score: 741 },
  { id: "a3", ref: "RCL-H9T56LSE", applicant: "P. Sithole", amount: 22000, status: "submitted", worker: "—", submitted: "2026-06-11", score: null },
  { id: "a4", ref: "RCL-M3W88VXC", applicant: "A. Botha", amount: 5000, status: "approved", worker: "S. Dlamini", submitted: "2026-06-09", score: 788 },
  { id: "a5", ref: "RCL-Q1Y44KDR", applicant: "F. Mahlangu", amount: 30000, status: "declined", worker: "K. Naidoo", submitted: "2026-06-08", score: 389 },
];
...
export default function AdminDashboard() {
  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", minHeight: "100vh", background: "#F9FAFB" }}>
      {/* Header */}
      <div style={{ background: NAVY, color: "#fff", display: "flex", alignItems: "center", gap: 16, padding: "14px 28px", borderBottom: `3px solid ${GOLD}` }}>
        ...
        <div>
          <div style={{ fontWeight: 700, fontSize: 16, letterSpacing: 0.3 }}>RAMUS CASH LOANS</div>
      ...
      <div style={{ display: "flex", minHeight: "calc(100vh - 70px)" }}>
        {/* Sidebar */}
        <div style={{ width: 220, background: "#fff", borderRight: "1px solid #E5E7EB", padding: "20px 0", flexShrink: 0 }}>
          {tabs.map(t => (
